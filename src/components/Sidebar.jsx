...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-slate-900 h-screen sticky top-0 flex flex-col border-r border-slate-800 text-slate-300">
      <div className="p-6 flex items-center gap-3 border-b border-slate-800/50">
        <Logo className="w-8 h-8 brightness-200" />
        <div className="flex flex-col">
          <span className="text-lg font-bold text-white tracking-tight leading-none">BookstoreIMS</span>
      ...
      <div className="p-4 border-t border-slate-800 mt-auto">
        ...
        <button onClick={logout} className="btn btn-sm btn-outline btn-block border-slate-700 text-slate-400 hover:bg-slate-800 hover:text-white hover:border-slate-600 normal-case">
          Sign Out
        </button>
      </div>
    </aside>
