    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-[#f1f5f9] font-['DM_Sans',sans-serif] text-[#1e293b]">
      <div className="flex w-full max-w-[780px] min-h-[540px] rounded-2xl overflow-hidden bg-white border-[0.5px] border-[#e2e8f0] shadow-[0_4px_24px_rgba(0,0,0,0.08)]">
        ...
        <div className="flex-1 p-8 md:p-10 flex flex-col">
          ...
          <div className="font-['Playfair_Display',serif] text-[22px] font-medium text-[#1e293b] mb-1">Staff Registration</div>
          <div className="text-[12px] text-[#64748b] mb-6">Complete your account setup using your invitation email.</div>

          <div className="bg-[#F5EFDF] border border-[#C8A96E]/30 rounded-lg p-3 text-[11.5px] text-[#7A5C1E] mb-4 flex gap-2">
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" className="shrink-0 mt-0.5"><circle cx="7" cy="7" r="6" stroke="#C8A96E" strokeWidth="1.2"/><path d="M7 6v4M7 4.5v.5" stroke="#C8A96E" strokeWidth="1.2" strokeLinecap="round"/></svg>
          ...
          <form onSubmit={handleRegister} className="flex flex-col flex-1">
            <div className="mb-4">
              <label className="text-[11.5px] font-medium text-[#64748b] tracking-wide mb-1.5 block">Invited email address</label>
              <input 
            ...
            <div className="flex gap-3 mb-4">
              <div className="flex-1">
                <PasswordInput label="Create password" value={formData.password} onChange={(e) => setFormData({...formData, password: e.target.value})} disabled={loading} />
              </div>
              <div className="flex-1">
                <PasswordInput label="Confirm password" value={formData.confirmPass} onChange={(e) => setFormData({...formData, confirmPass: e.target.value})} disabled={loading} />
              </div>
            </div>
