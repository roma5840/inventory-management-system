    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-[#f1f5f9] font-['DM_Sans',sans-serif] text-[#1e293b]">
      <div className="flex w-full max-w-[780px] min-h-[540px] rounded-2xl overflow-hidden bg-white border-[0.5px] border-[#e2e8f0] shadow-[0_4px_24px_rgba(0,0,0,0.08)]">
        ...
        <div className="flex-1 p-8 md:p-10 flex flex-col">
          <div className="font-['Playfair_Display',serif] text-[22px] font-medium text-[#1e293b] mb-1">Reset Password</div>
          <div className="text-[12px] text-[#64748b] mb-6">Enter your registered email to receive a secure reset link.</div>
          
          {error && <div className="bg-red-50 text-red-600 p-2 rounded text-[11px] mb-4 border border-red-100">{error}</div>}
          {msg && <div className="bg-emerald-50 text-emerald-700 p-2 rounded text-[11px] mb-4 border border-emerald-100">{msg}</div>}
          ...
          {!msg ? (
            <form onSubmit={handleReset} className="flex flex-col flex-1">
              ...
              <div className="text-center text-[12px] text-[#64748b]">
                Remember your password? <Link to="/login" className={`text-[#C8A96E] font-medium hover:underline ${loading ? "pointer-events-none opacity-50" : ""}`}>Sign in</Link>
              </div>
            ...
            <div className="flex flex-col flex-1">
              ...
              <div className="text-center text-[12px] text-[#64748b]">
                <Link to="/login" className={`text-[#C8A96E] font-medium hover:underline ${loading ? "pointer-events-none opacity-50" : ""}`}>Back to Login</Link>
              </div>
