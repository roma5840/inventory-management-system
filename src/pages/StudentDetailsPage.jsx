                                                        ...
                                                        <div className="px-6 py-5 border-l-4 border-indigo-200">
                                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                                                <div className="space-y-3">
                                                                    ...
                                                                    {first.released_by && <div><span className="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-1">Released By</span><span className="text-xs font-bold text-slate-700">{first.released_by}</span></div>}
